// Maison Velour — API server backed by Supabase (cloud Postgres)
...
/* ---- Supabase data helpers (mirror the old SQLite queries) ---- */
...
const server = http.createServer(async (req, res) => {
  ...
  /* ---- Static files (serve the site from the same server) ---- */
...
server.listen(PORT, () => console.log(`Maison Velour API (Supabase) running at http://localhost:${PORT}`));
