// Vercel serverless function — self-contained (inlined handler + supabase client)
// Every failure is caught and returned as JSON to avoid FUNCTION_INVOCATION_FAILED.
...
// ---- API handler (inlined from api-handler.js) ----
